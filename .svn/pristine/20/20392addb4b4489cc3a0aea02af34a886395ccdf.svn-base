...
@JGlobalMap // (excluded = { "detailList" }) // 之前没有加，导致详情没有显示出来
public class InspectionDTO {
	...
	private List<InspectionDetailDTO> detailList;// 子菜单的详情页面
	...
	public List<InspectionDetailDTO> getDetailList() {
		return detailList;
	}

	public void setDetailList(List<InspectionDetailDTO> detailList) {
		this.detailList = detailList;
	}

	@Override
	public String toString() {
		return "InspectionDTO [inspectionApplyId=" + inspectionApplyId + ", purchaseOrderId=" + purchaseOrderId
