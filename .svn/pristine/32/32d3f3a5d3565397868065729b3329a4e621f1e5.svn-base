...
public interface TaskFlowControlService
{
	 ...
	 * 后加签
	 */
	ActivityImpl[] insertTasksAfter(String taskId, String targetTaskDefinitionKey, String... assignees) throws Exception;

	/**
	 * 前加签
	 */
	ActivityImpl[] insertTasksBefore(String taskId, String targetTaskDefinitionKey, String... assignees) throws Exception;
