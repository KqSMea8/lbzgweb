<template>
  <Modal v-model="display" title="选择物料" :closable="false" :mask-closable="false" :transfer="transfer" :width="800" class="selmaterial">
     <div class="page">
      <div class="page-searchbox">
        <table cellpadding="0" cellspacing="0">
          <tr>
            <td>
              <Input v-model="queryForm.keyword" placeholder="物料编码/名称/图号" style="width:200px;" @keyup.enter.native="query" ></Input>
            </td>
            <td>
