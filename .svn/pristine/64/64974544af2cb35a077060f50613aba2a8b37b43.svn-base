<template>
  <Modal v-model="display" title="选择采购不合格品单号" :closable="close" :mask-closable="true" width="1000" class="selcustomer" :transfer="transfer">
    <div class="page">
    ...
    export default {
        ...
        methods: {
            ...
            load() {
                ...
                this.$http.post("/api/UnqualifiedProductBill/list", this.queryParam).then((res) => {
                    this.loading = 0;
