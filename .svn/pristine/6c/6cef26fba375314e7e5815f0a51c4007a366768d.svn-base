...
public class ComplaintDisposeBean {
	...
	public Date getFirstDeliver() {
		return firstDeliver;
	}

	public void setFirstDeliver(Date firstDeliver) {
		this.firstDeliver = firstDeliver;
	}
