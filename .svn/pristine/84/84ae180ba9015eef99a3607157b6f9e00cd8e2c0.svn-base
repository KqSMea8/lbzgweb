  ...
  <div class="page instock-edit">
    ...
    <div class="baseinfo"> 
      ...
      <table cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td>
            <FormItem prop="operateTime" label="单据日期">
              <Input v-model="formItem.billDate" :readonly="true"></Input>
            </FormItem>
          </td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td>
            <FormItem prop="" label="采购单、入库申请单">
              {{formItem.relatedBillId1}}&nbsp;{{formItem.relatedBillId}}
            </FormItem>
          </td> 
          <td>
            <FormItem prop="amount" label="总金额">
              {{formItem.amount}}
            </FormItem>
          </td> 
