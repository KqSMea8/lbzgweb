<template>
    <Modal v-model="display" title="选择物料" :closable="false" :mask-closable="false" width="800" class="selcustomer" :transfer="transfer" ref="page">
        <div class="page">
            <div class="page-searchbox" >
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <td>物料代码：</td>
                        <td>
                            <Input v-model="queryForm.materId" placeholder="物料代码" ></Input>
                        </td>
                        <td>物料名称：</td>
                        <td>
                        ...
                        <td>规格：</td>
                        <td>
                            <Input v-model="queryForm.spec" placeholder="规格" ></Input>
                        </td>
                        <td>型号：</td>
                        <td>
                            <Input v-model="queryForm.model" placeholder="型号" ></Input>
                        </td>
                        <td>
  ...
  export default {
    ...
    methods: {
      ...
      load() {
        ...
        this.$http.post("/api/instrument/find", this.queryParam).then((res) => {
          this.loading = 0;
          this.loading = 0;
