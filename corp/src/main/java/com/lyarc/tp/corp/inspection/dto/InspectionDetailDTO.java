package com.lyarc.tp.corp.inspection.dto;
...
public class InspectionDetailDTO {
	...
	public String toString() {
		return "InspectionDetailDTO [inspectionApplyId=" + inspectionApplyId + ", materId=" + materId + ", subType="
				+ subType + ", materName=" + materName + ", level=" + level + ", spec=" + spec + ", model=" + model
				+ ", use=" + use + ", providerId=" + providerId + ", origin=" + origin + ", unit=" + unit
				+ ", needDate=" + needDate + ", price=" + price + ", quantity=" + quantity + ", amount=" + amount
				+ ", buyer=" + buyer + ", arrivalDate=" + arrivalDate + ", arrivalQuantity=" + arrivalQuantity
				+ ", originBatch=" + originBatch + ", batch=" + batch + ", madeDate=" + madeDate + ", validityDate="
				+ validityDate + ", qualityTime=" + qualityTime + ", remark=" + remark + ", creator=" + creator
				+ ", createTime=" + createTime + ", updateTime=" + updateTime + ", tmstamp=" + tmstamp + "]";
	}
