...
public class ProductStockBillBean {
	...
	private List<ProductStockBillDetail> detailList;
	...
	public List<ProductStockBillDetail> getDetailList() {
		return detailList;
	}

	public void setDetailList(List<ProductStockBillDetail> detailList) {
