...
import com.lyarc.tp.corp.workflowact.ctrl.command.CreateAndTakeTransitionCmd;
import com.lyarc.tp.corp.workflowact.ctrl.command.DeleteRunningTaskCmd;
import com.lyarc.tp.corp.workflowact.ctrl.command.StartActivityCmd;
import com.lyarc.tp.corp.workflowact.ctrl.common.SimpleRuntimeActivityDefinitionEntity;
import com.lyarc.tp.corp.workflowact.ctrl.creator.ChainedActivitiesCreator;
import com.lyarc.tp.corp.workflowact.ctrl.creator.MultiInstanceActivityCreator;
import com.lyarc.tp.corp.workflowact.ctrl.creator.RuntimeActivityDefinitionEntityIntepreter;
...
public class DefaultTaskFlowControlService implements TaskFlowControlService
{
	...
	private ActivityImpl[] cloneAndMakeChain(String taskId,String prototypeActivityId, String nextActivityId, String... assignees)
			throws Exception
	{
	 ...
	 */
	@Override
	public ActivityImpl[] insertTasksAfter(String taskId,String targetTaskDefinitionKey, String... assignees) throws Exception
	{
		...
		return cloneAndMakeChain(taskId,targetTaskDefinitionKey, prototypeActivity.getOutgoingTransitions().get(0)
	 ...
	 */
	@Override
	public ActivityImpl[] insertTasksBefore(String taskId,String targetTaskDefinitionKey, String... assignees) throws Exception
	{
		return cloneAndMakeChain(taskId,targetTaskDefinitionKey, targetTaskDefinitionKey, assignees);
	}
