<template>
<Modal v-model="display" title="选择供应商" :closable="false" :mask-closable="false" width="800" class="selprovider" :transfer="transfer">
  <div class="page">
    <div class="page-searchbox">
      <table cellpadding="0" cellspacing="0">
        <tr>
          <td>
            <Input v-model="queryForm.keyword" placeholder="供应商代码、名称查询" ></Input>
          </td>
          <td>
  ...
  export default {
    ...
    methods: { 
      load() {
        ...
        this.$http.post("/api/provider/list", this.queryParam).then((res) => {
          this.loading = 0;
          if (res.data.code === 0) {
            this.loading = 0;
