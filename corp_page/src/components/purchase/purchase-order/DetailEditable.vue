    ...
    <table cellspacing="0" cellpadding="0" v-else>
        ...
        <tbody>
          <tr v-for="(item,index) in list"  :key="'mater_'+index" @click="curIndex = index">
            ...
            <td >
              {{$args.getArgText('material_class',item.materType)}} 
            </td>
            <td >
              {{$args.getArgText('unit',item.unit)}}  
            </td>
            ...
            <td > 
              <Input  type="text" v-model="item.providerName" style="width: 150px"/>
            </td>
            <td>
              <Input  type="text" v-model="item.origin" style="width: 150px"/>
            </td>
            <td class="col-date"> 
