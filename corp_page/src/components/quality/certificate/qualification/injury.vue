  ...
  <div class="page inquireview">
    <div class="page-bar">
      <LayoutHor>
        ...
        <div class="page-bar-title">磁粉探伤检验报告</div>
        <div class="page-bar-title"> MAGNETIC PARTICLE TEST REPORT</div>
      </LayoutHor>
    </div>
    <Loading :loading="loading" style="border: solid 1px #797979">
      ...
      <Editable v-for="(item) in formItem" :isList="isList" :queryForm="queryForm" :material="item"></Editable>
...
<script>
    ...
    import Editable from './injuryDetailCard';
        ...
        methods: {
            open(item){
                ...
                * */
                ...
                Object.assign(this.queryForm,item2);console.log(this.queryForm,item2);
                this.formItem[0]=1;
