         ...
         <div  class="editable-table">
           ...
           <table cellspacing="0" cellpadding="0">
            <thead>
             <th>生产厂家</th>
             <th>名称</th>
             <td colspan="2"><Input  type="text" v-model="list.detailList[0].brickTubeName" /></td>
             <th>型号</th>
             <td colspan="2"><Input  type="text" v-model="list.detailList[0].brickTubeType" /></td>
             </thead>
             <tbody>
            <tr>
               <td rowspan="3"><Input  type="text" v-model="list.detailList[0].origin"/></td>
               <td colspan="6"><Input  type="number" v-model="list.detailList[0].stockQuantity" placeholder="进货数量"/></td>
             </tr>
             <tr>
               <td colspan="6"><Input  type="number" v-model="list.detailList[0].spotCheckQuantity" placeholder="抽检数量"/></td>
             </tr>
             <th><tr>裂纹 </tr></th>
             <th><tr>毛刺</tr></th>
             <th><tr>损伤</tr></th>
             ...
             <tr>
               <th>数量</th>
               <td v-for="(item,index) in list.detailList"><Input  type="number" v-model="item.quantity" /></td>
             </tr>
             <tr>
               <th>抽检合格率</th>
               <td v-for="(item,index) in list.detailList"><Input  type="number" v-model="item.spotCheckYieid" /></td>
             </tr>
             <tr>
               <th>合格数量</th>
               <td colspan="6" ><Input  type="number" v-model="list.detailList[0].qualifiedNo" /></td>
             </tr>
             <tr>
               <th>合格率</th>
               <td colspan="6"><Input  type="number" v-model="list.detailList[0].yieid" /></td>
             </tr>
             <tr>
               <th>结论</th>
               <td colspan="6"><Input  type="text" v-model="list.detailList[0].conclusion" /></td>
             </tr>
             </tbody>
           </table>
           <br/>
           <table cellspacing="0" cellpadding="0">
            <thead>
             ...
             <tbody>
             <tr>
               <td colspan="6"><Input  type="text" v-model="list.detailList[0].stockQuantity" placeholder="进货数量"/></td>
             </tr>
             <tr>
               <td colspan="6"><Input  type="text" v-model="list.detailList[0].spotCheckQuantity" placeholder="抽检数量"/></td>
             </tr>
             <th><tr>裂纹 </tr></th>
             <th><tr>毛刺</tr></th>
             <th><tr>损伤</tr></th>
             ...
             <th><tr>端面平面度</tr></th>
             <tr>
               <td v-for="(item,index) in list.detailList"><Input  type="text" v-model="item.checkQuantity" /></td>
             </tr>
             <tr>
               <td v-for="(item,index) in list.detailList"><Input  type="text" v-model="item.spotCheckYieid" /></td>
             </tr>
             <tr>
               <td colspan="6"><Input  type="number" v-model="list.detailList[0].qualifiedNo" /></td>
             </tr>
             ...
             <tr>
               <td colspan="6"><Input  type="number" v-model="list.detailList[0].conclusion" /></td>
             </tr>
             </tbody>
           </table>
           <br/>
           <table cellspacing="0" cellpadding="0">
             ...
             <tbody>
               <td>
                 <Input  type="text" v-model="list.lotMoisture" />
               </td>
               <td>
                 <Input  type="text" v-model="list.conclusion" />
               </td>
             </tbody>
           </table>
           <br/>
  ...
  export default {
    ...
    methods: {
      load() {
        ...
        this.$http.post("/api/revision/getNewCheckBrickTube?batchId=" + this.batchId+"&versionId="+this.versionId,{}).then((res) => {
          this.loading = 0;
          if (res.data.code == 0) {
            if(res.data.data){
      ...
      save(){
        ...
        // 提交
        this.loading = 1;
        /*var uri = '/api/revision/addAllCheckBrickTube';*/
