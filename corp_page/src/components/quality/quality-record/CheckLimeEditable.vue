       ...
       <div class="inquire-detail-card editable">
         ...
         <div class="editable-table">
           ...
           <table cellspacing="0" cellpadding="0">
             ...
             <tr>
               <th>标准</th>
               <td><!--{{list.standard}}--><Input  type="text" v-model="list.standard" /></td>
               <td rowspan="2"><Input  type="text" v-model="list.conclusion" /></td>
             </tr>
             <tr>
               <th>实测</th>
               <td><!--{{list.actual}}--><Input  type="text" v-model="list.actual" /></td>
             </tr>
             </thead>
           </table>
           <br/>
...
<script>
  ...
  export default {
    ...
    methods: {
      load() {
        this.loading = 1;
        this.$http.post("/api/revision/getNewCheckLime?batchId=" + this.batchId+"&versionId="+this.versionId,{}).then((res) => {
          this.loading = 0;
          if (res.data.code == 0) {
            if(res.data.data){
      ...
      save(){
       ...
       /* for(var i = 0;i<this.list.length;i++){
        ...
        // 提交
        this.loading = 1;
        var uri = '/api/revision/addAllCheckLime';
        /*if(this.pageFlag == 2){
