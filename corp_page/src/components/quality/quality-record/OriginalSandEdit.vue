      ...
      <div>
       ...
       <div class="inquire-detail-card editable">
         ...
         <div class="editable-table">
           ...
           <table cellspacing="0" cellpadding="0">
             <thead>
             <th rowspan="2" width="100">筛孔尺寸（mm）</th>
             <td v-for="(item,index) in itemOneObj"><!--{{item.detail.aperture_size}}--><Input  type="number" v-model="item.detail.aperture_size" /></td>
             <!--<td v-for="(item,index) in itemOneObj">&lt;!&ndash;{{item.detail.aperture_size}}&ndash;&gt;<Input  type="text" v-model="list.colloidIndex" /></td>-->
             <tr>
               <th>3.35</th>
               <th>1.70</th>
               <th>0.850</th>
             ...
             <tr>
               <th>残留量</th>
               <td v-for="(item,index) in itemOneObj"><!--{{item.detail.residual_quantity}}--><Input  type="number" v-model="item.detail.residual_quantity" /></td>
          ...
          var form =
              {
                  ...
                  siltContent:this.list.siltContent,
                  waterContent:this.list.waterContent,
                  colloidIndex:this.list.colloidIndex,
                  remark:this.list.remark,
                  conclusion:this.list.conclusion,
                  mainGrainComposition:this.list.mainGrainComposition,
                  granularityAvg:this.list.granularityAvg,
                  averageRate:this.list.averageRate,
                  fineRate:this.list.fineRate,
