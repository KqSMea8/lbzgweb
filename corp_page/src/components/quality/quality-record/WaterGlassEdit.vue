       ...
       <div class="inquire-detail-card editable">
         ...
         <div class="editable-table">
           ...
           <table cellspacing="0" cellpadding="0">
             ...
             <tr >
               <th>标准</th>
               <td><!--{{list.modulusStand}}--><Input  type="number" v-model="list.modulusStand" /></td>
               <td><!--{{list.proportionStand}}--><Input  type="number" v-model="list.proportionStand" /></td>
               <td rowspan="2"><!--{{list.conclusion}}--><Input  type="text" v-model="list.conclusion" /></td>
             </tr>
             <tr>
               <th>实测</th>
               <td><!--{{list.modulusMeasure}}--><Input  type="number" v-model="list.modulusMeasure" /></td>
               <td><!--{{list.proportionMeasure}}--><Input  type="number" v-model="list.proportionMeasure" /></td>
             </tr>
             </tbody>
           </table>
           <br/>
          ...
          var form =
              {
                  ...
                  modulusStand:this.list.modulusStand,
                  proportionStand:this.list.proportionStand,
                  modulusMeasure:this.list.modulusMeasure,
                  proportionMeasure:this.list.proportionMeasure,
                  conclusion:this.list.conclusion,
              };
       console.log(form)
        // 提交
        this.loading = 1;
        var uri = '/api/revision/addAllCheckWaterGlass';
