...
//3.采购 --->
//供应商
components.push({ component: 'provider/Index', name: '', path: '/provider' })//供应商列表，查询，新建，编辑，状态变更
components.push({ component: 'purchase/provider-material/Index', name: '', path: '/provider-material' })//供应商名录
...
//自用件制作申请
components.push({ component: 'production/selfmater/Index', name: '', path: '/selfmater' })//自用件制作申请首页
components.push({ component: 'production/selfmater/SelfMaterMakeEdit', name: '', path: '/selfmater/edit' })//新建或编辑自用件制作申请
